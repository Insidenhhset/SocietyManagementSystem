<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="SocietyManagementSystem.EditUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid mt-4">
        <h1 class="custom-heading">Edit Users</h1>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0 bg-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Users Data</li>
            </ol>
        </nav>
    ...
    <label for="TextBox2" class="form-label">Role</label>
            ...
            <div class="mb-3">
                <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Edit"  onclick="btnedit_clicked"  OnClientClick="return validateFields();" CausesValidation="false" />
